  ...
  return (
    <div name="contact" className="mx-10 md:mx-20 font-sans">
      <div className="flex flex-col justify-center items-center">
        <form action="https://getform.io/f/bllyqjyb" className="flex flex-col w-full max-w-[600px]" method="POST">
          ...
          <textarea className="bg-gray-300 text-slate-700 p-2 rounded-lg" type="text" placeholder="Your Message" name="message" rows="5"></textarea>
