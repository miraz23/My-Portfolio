...
const Banner = () => {
    ...
    return (
        <div name="home" className='h-[100vh] flex flex-col justify-center items-center font-sans'>
            <div className='mx-10 md:mx-20'>
                ...
                <h2 className='text-[#8892b0] font-bold text-4xl md:text-5xl' data-aos='fade-left' data-aos-duration='2000'>I am a Full-Stack Developer,</h2>
